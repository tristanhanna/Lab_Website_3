...
function player_info(req, res) {  // Default if select_player query fails
...
app.get('/player_info', player_info);
...
app.get('/player_info/post', function(req, res) {
  ...
  var users = 'select id,name from football_players;';
    
  var player_stats = 'select * from football_players where id = ' + player_id + ';';
    
  var games = 'select count(*) from football_games left join football_players on football_players.id = any(football_games.players) where football_players.id=' + player_id + ';';
  ...
  .then(data=>{
    ...
    //dont give a shit about error log rn
  .catch(err => {
    console.log(err);
  });
});
